...
# ls /mnt/user-ssd/chenzhiyang1/workspace/Train/Gumiho/train_data/Qwen2.5-1.5B-Instruct/ShareGPT_V4.3_unfiltered_cleaned_split.json/0_68000_mufp16

# Default parameters
OUTDIR="/mnt/user-ssd/chenzhiyang1/workspace/Train/Gumiho/train_data/gumiho"
START=0
# END=10
END=10000
# END=207800
...
# Build the command
CMD="python3 gumiho/ge_data/allocation.py \
    --outdir \"$OUTDIR\" \
    --start_idx \"$START\" \
    --end_idx \"$END\" \
