...
parser.add_argument('--start_idx', type=int, default=0, help='Start index for data range')
parser.add_argument('--end_idx', type=int, default=67999, help='End index for data range')
