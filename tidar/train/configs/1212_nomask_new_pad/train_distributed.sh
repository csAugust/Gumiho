...
CONFIG_FILE="tidar/train/configs/1212_nomask_new_pad/train_config.json"
DS_CONFIG="tidar/train/configs/1212_nomask_new_pad/ds_config_distributed_bf16.json"
