...
CONFIG_FILE="tidar/train/configs/1215_nomask_newpad_fixlr/train_config.json"
DS_CONFIG="tidar/train/configs/1215_nomask_newpad_fixlr/ds_config_distributed_bf16.json"
